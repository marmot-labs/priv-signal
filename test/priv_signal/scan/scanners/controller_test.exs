defmodule PrivSignal.Scan.Scanners.ControllerTest do
  ...
  test "detects controller json response as exposure sink" do
    inventory = fixture_inventory()
    path = fixture_path("lib/fixtures/controller_response_sink.ex")
    {:ok, ast} = AST.parse_file(path)

    findings =
      Controller.scan_ast(ast, %{path: path}, inventory,
